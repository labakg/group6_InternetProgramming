...
<div class="container">
            ...
            <div class="jumbotron">
                ...
                <p class="lead">
                    ...
                    if($username == ""){
                        ...
                        echo "<a class='btn btn-primary btn-lg' href='review.php?eateryID=2' role='button'>Leave a review!</a>";
                    }
                    $totalReviews =0;
                    $totalRating = 0;
    ...
    <div class="col-md-10">
        ...
        $query2 = $conn2->prepare("SELECT Post.postID, Post.title, Post.review, Post.rating, User.userName, Eatery.eateryName, Post.time FROM Post INNER JOIN Eatery ON Post.eateryID = Eatery.eateryID INNER JOIN User ON Post.userID = User.userID WHERE Post.eateryID = 2");
        $query2->execute();
